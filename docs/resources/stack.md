...
- `prevent_changes_when_locked` (Boolean) If true, Terraform will fail during planning when the stack is locked and the plan includes changes to this resource. Defaults to `false`.
